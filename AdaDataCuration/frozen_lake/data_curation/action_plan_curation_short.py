...
def generate_action_plan_dataset(jsonl_file_path: str, output_file_path: str,
    ...
    with open(jsonl_file_path, 'r') as f:
        for line in f:
            ...
            expected_answer = "\\boxed{"+expected_actions+"}"
            
            # Replace placeholders in the prompt
            prompt = ACTION_PLAN_PROMPT_SHORT
...
if __name__ == "__main__":
    ...
    parser.add_argument('--repo-name', type=str, default='frozen-lake-action-plan-single-image-tag-10k',
                       help='Base repository name (default: frozen-lake-action-plan-single-image-tag-10k)')

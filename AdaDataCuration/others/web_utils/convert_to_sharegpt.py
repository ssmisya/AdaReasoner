...
def main():
    # 读取输入的jsonl文件
    input_data_path = "/mnt/petrelfs/songmingyang/share_data/sunhaoyu/datasets/web/gemini_test_format_conversation.jsonl"
    ...
    # 写入输出json文件
    output_data_path = "/mnt/petrelfs/songmingyang/share_data/sunhaoyu/datasets/web/webdata_sharegpt.json"

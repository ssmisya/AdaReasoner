...
candidate_path="/mnt/petrelfs/songmingyang/code/reasoning/data_construction/PixelReasoner/data/pixelreasonersft_crop_candidates.jsonl"
output_path="/mnt/petrelfs/songmingyang/code/reasoning/data_construction/PixelReasoner/data/pixelreasonersft_crop_formatted.jsonl"
...
--first_prompt "pixelreasonersft_crop" \

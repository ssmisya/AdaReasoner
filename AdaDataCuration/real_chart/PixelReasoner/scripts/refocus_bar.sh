...
candidate_path="/mnt/petrelfs/songmingyang/code/reasoning/data_construction/refocus/data/refocus_chartqa_v_bar_wbb_candidates.jsonl"
output_path="/mnt/petrelfs/songmingyang/code/reasoning/data_construction/refocus/data/refocus_chartqa_v_bar_wbb_reformatted.jsonl"
...
--first_prompt "refocus_bar_highlight" \
--inference_type "refocus"

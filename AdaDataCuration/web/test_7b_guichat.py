...
api_key = "not-needed"
model_name = "/mnt/petrelfs/share_data/ai4good_shared/models/Qwen/Qwen2.5-VL-7B-Instruct-new" # 例如使用这个VL模型
...
output_file = "/mnt/petrelfs/sunhaoyu/visual-code/Tool-Data-Curation/web/test_results/guichat/7b_responses.jsonl"

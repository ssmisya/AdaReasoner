...
export EXPERIMENT_NAME="qwen2_5_sft100_7b_frozenlake"
...
export LDFLAGS="-ldl"
export CFLAGS="-Ilibaio/usr/include $CFLAGS"
export LDFLAGS="-Llibaio/usr/lib $LDFLAGS"
...
FROZENLAKE_DATASET_TRAIN="create_datasets/train.parquet"
...
REF_MODEL_PATH="/mnt/petrelfs/share_data/songmingyang/runs/tool_factory/sft/v1/Qwen2.5-VL-7B-Instruct-vsp2tasks_v0verify_v2navigation/checkpoint-100"

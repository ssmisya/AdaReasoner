...
export EXPERIMENT_NAME="qwen2_5_sft100_7b_frozenlake_test"
...
FROZENLAKE_DATASET_TRAIN="/mnt/petrelfs/sunhaoyu/visual-code/create_datasets/test.parquet"
...
REF_MODEL_PATH="/mnt/petrelfs/share_data/songmingyang/runs/tool_factory/sft/v1/Qwen2.5-VL-7B-Instruct-pathverify_v2/checkpoint-100"

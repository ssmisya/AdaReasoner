...
export EXPERIMENT_NAME="vsp2tasks_v2"
...
REF_MODEL_PATH="/mnt/petrelfs/share_data/songmingyang/runs/tool_factory/sft/v1/Qwen2.5-VL-7B-Instruct-vsp2tasks_v2"
...
python_cmd="python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.rollout.agent.tool_manager.controller_addr=http://SH-IDC1-10-140-37-21:50001 \
    ...
    custom_reward_function.path=/mnt/petrelfs/sunhaoyu/visual-code/DeepEyes/verl/utils/reward_score/frozenlake2.py"

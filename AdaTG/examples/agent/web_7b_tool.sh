...
export EXPERIMENT_NAME="web_7b_tool"
...
FROZENLAKE_DATASET_TRAIN="/mnt/petrelfs/sunhaoyu/visual-code/datasets/web_guichat_rl/train.parquet"
# FROZENLAKE_DATASET_VAL="/mnt/petrelfs/sunhaoyu/visual-code/datasets/web_guichat_rl/test.parquet"
FROZENLAKE_DATASET_VAL="/mnt/petrelfs/sunhaoyu/visual-code/datasets/webmmu_test/test.parquet"
REF_MODEL_PATH="/mnt/petrelfs/share_data/ai4good_shared/models/Qwen/Qwen2.5-VL-7B-Instruct-new"
# REF_MODEL_PATH="/mnt/petrelfs/share_data/songmingyang/runs/tool_factory/sft/v1/Qwen2.5-VL-7B-Instruct-webqa_v1/checkpoint-200"

# 乘以5会报错cuda oom
MAX_PIXELS=1280*28*28*3

# 4. 构建并执行训练命令 (已集成srun)
node_list="SH-IDC1-10-140-37-21"
# node_list="SH-IDC1-10-140-37-154"
gpus=0 
cpus=2
partition="ai_moe"
quotatype="reserved"
...
python_cmd="python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.rollout.agent.tool_manager.controller_addr=http://SH-IDC1-10-140-37-6:21112 \
    ...
    custom_reward_function.path=/mnt/petrelfs/sunhaoyu/visual-code/DeepEyes/verl/utils/reward_score/web_reward44.py"

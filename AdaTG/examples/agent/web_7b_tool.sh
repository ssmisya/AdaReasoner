...
FROZENLAKE_DATASET_TRAIN="/datasets/web_guichat_rl/train.parquet"
# FROZENLAKE_DATASET_VAL="/datasets/web_guichat_rl/test.parquet"
FROZENLAKE_DATASET_VAL="/datasets/webmmu_test/test.parquet"
...
python_cmd="python3 -m verl.trainer.main_ppo \
    ...
    custom_reward_function.path=/DeepEyes/verl/utils/reward_score/web_reward44.py"

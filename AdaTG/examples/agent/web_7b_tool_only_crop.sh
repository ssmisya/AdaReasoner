...
export EXPERIMENT_NAME="web_7b_tool_only_crop"
...
FROZENLAKE_DATASET_TRAIN="/mnt/petrelfs/sunhaoyu/visual-code/datasets/web_guichat_rl_crop/train.parquet"
FROZENLAKE_DATASET_VAL="/mnt/petrelfs/sunhaoyu/visual-code/datasets/web_guichat_rl_crop/test.parquet"
...
python_cmd="python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.rollout.agent.tool_manager.controller_addr=http://SH-IDC1-10-140-37-6:21114 \

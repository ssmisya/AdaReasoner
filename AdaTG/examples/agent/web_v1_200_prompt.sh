...
export EXPERIMENT_NAME="web_v1_200_prompt"
...
python_cmd="python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.rollout.agent.tool_manager.controller_addr=http://SH-IDC1-10-140-37-6:21113 \
    ...
    custom_reward_function.path=/mnt/petrelfs/sunhaoyu/visual-code/DeepEyes/verl/utils/reward_score/web.py"

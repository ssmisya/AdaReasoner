...
export EXPERIMENT_NAME="vsp2tasks_v2_2_nav"
...
export LLM_AS_A_JUDGE_BASE="http://SH-IDC1-10-140-37-21:16112/v1"
export no_proxy="localhost,127.0.0.1,sh-idc1-10-140-37-21,10.140.37.21,sh-idc1-10-140-37-6,10.140.37.6"
...
REF_MODEL_PATH="/mnt/petrelfs/share_data/songmingyang/runs/tool_factory/sft/v1/Qwen2.5-VL-7B-Instruct-vsp2tasks_v2.2_navigationa/checkpoint-100"


# 4. 构建并执行训练命令 (已集成srun)
node_list="SH-IDC1-10-140-37-82"
...
python_cmd="python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.rollout.agent.tool_manager.controller_addr=http://SH-IDC1-10-140-37-82:50001 \
    ...
    custom_reward_function.path=/mnt/petrelfs/sunhaoyu/visual-code/DeepEyes/verl/utils/reward_score/frozenlake1.py"

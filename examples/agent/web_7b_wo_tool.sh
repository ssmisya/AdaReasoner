...
export EXPERIMENT_NAME="web_7b_wo_tool"
...
FROZENLAKE_DATASET_TRAIN="/mnt/petrelfs/sunhaoyu/visual-code/datasets/web_guichat_rl_wo_tool/train.parquet"
# FROZENLAKE_DATASET_VAL="/mnt/petrelfs/sunhaoyu/visual-code/datasets/web_guichat_rl/test.parquet"
FROZENLAKE_DATASET_VAL="/mnt/petrelfs/sunhaoyu/visual-code/datasets/web_guichat_rl_wo_tool/test.parquet"
...
python_cmd="python3 -m verl.trainer.main_ppo \
    ...
    custom_reward_function.path=/mnt/petrelfs/sunhaoyu/visual-code/DeepEyes/verl/utils/reward_score/web_no_tool.py"

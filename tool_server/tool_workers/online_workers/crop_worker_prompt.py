        ...
        try:
            ...
            if match:
                try:
                    ...
                    success_message = f"Image cropped successfully using absolute coordinates. If the cropped area is not what you want or does not contain the information you need, you should call crop again."

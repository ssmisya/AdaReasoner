...
def single_request(thread_id, worker_addr, model_name, img_arg, obj_param=None):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if "edited_image" in result:
                ...
                image.save(f"molmo_result_{thread_id}.jpg")
...
def test_parallel_molmo():
    print("Testing parallel molmo requests...")
    ...
    with ThreadPoolExecutor(max_workers=num_threads) as executor:
        futures = [executor.submit(single_request, i, worker_addr, model_name, img_arg, args.obj) 
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--image_path", type=str, default="tool_server/tool_workers/online_workers/test_cases/worker_tests/input_cases/two_col_102588.png"
    )

...
def main():
    ...
    parser.add_argument("--input", type=str, default="tool_server/tool_workers/tool_manager/randomize/webdata_ocr_sharegpt.json", help="Input JSON file path")
    parser.add_argument("--output", type=str, default="tool_server/tool_workers/tool_manager/randomize/web_v1_new_desc.json", help="Output JSON file path")
    ...
    # Web: /datasets/web/webdata_ocr_sharegpt.json
